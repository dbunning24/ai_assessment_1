# code mostly generated by chatgpt, human modifications have been made
...
# =========================
# Education rules (categorical) - use aggregated buckets from df
# =========================
educations = sorted(df["education"].dropna().unique().tolist())
for ed in educations:
    model.add_rule(f"education_{str(ed).replace('-', '_').replace(' ','_')}", lambda r, ed=ed: r["education"] == ed)

# =========================
# Education-num (continuous)
# =========================
model.add_rule("education_num_over_12", lambda r: r["education-num"] > 12)
model.add_rule("education_num_over_14", lambda r: r["education-num"] > 14)
